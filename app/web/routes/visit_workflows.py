    ...
    *,
    ...
    return templates.TemplateResponse(
        "visit_workflows.html",
        {
            ...
            "recent_sessions": visit_service.list_recent_sessions(db, limit=25),
            "draft_sessions": visit_service.list_recent_draft_sessions(db, limit=25),
            "submitted_sessions": visit_service.list_recent_submitted_sessions(db, limit=25),
